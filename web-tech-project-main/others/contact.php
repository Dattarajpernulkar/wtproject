...
<body>
    ...
    <div class="container">
        ...
        <section class="location">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3844.8435842615295!2d73.81898051477846!3d15.492843458741197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfc0928211990f%3A0xec46e52423fde348!2sSanta%20Inez%2C%20Panaji%2C%20Goa%20403001!5e0!3m2!1sen!2sin!4v1621495590240!5m2!1sen!2sin"
        ...
        <section class="contactus">
            <div class="row">
                <div class="contactcol">
                    <div>
                        <i><img src="image/placeholder.png" width="20px" height="20px"></i>
                        <span>
                            <h5>suj road radhe estate colony</h5>
                            <p>panaji goa</p>
                        </span>
                    </div>
                    <div>
                        <i><img src="image/telephone.png" width="20px" height="20px"></i>
                        <span>
                            <h5>1234567890</h5>
                            <p>Monday to Sunday,10am to 9pm</p>
                        </span>
                    </div>
                    <div>
                        <i><img src="image/mail.png" width="20px" height="20px"></i>
                        <span>
                            <h5>www.sweetcart@gmail.com</h5>
                ...
                <div class="contactcol">
                    <form action="" method="POST">
                        <input class="an" type="text" placeholder="Name" required>
                        <input class="an" type="email" placeholder="Email ID" required>
                        <input class="an" type="text" placeholder="Phone Number" required>
                        <textarea class="an" rows="8" placeholder="Message" required></textarea>
