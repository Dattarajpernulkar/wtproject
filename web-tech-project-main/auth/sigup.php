...
<body>
    <div class="formbox">
        ...
        <form class="inputgrp1">
            <input type="text" class="inputfeild" placeholder="name" required>
            <input type="email" class="inputfeild" placeholder="email id" required>
            <input type="password" class="inputfeild" placeholder="enter password" required>
            <div class="abcd"><a href=""> </a></div>
            <button type="submit" class="submitbtn">sign up</button>
        </form>

        <?php
            if(isset($_POST["em"]) && isset($_POST["pw"]) && isset($_POST["nm"])){
                $nm = $_POST["nm"];
                $em = $_POST["em"];
                $pw = $_POST["pw"];

                $query = "insert into `accounts` (`name`, `email`, `password`) values ('$nm', '$em', '$pw');";
